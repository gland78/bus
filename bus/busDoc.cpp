...
// 축소판 그림을 지원합니다.
void CbusDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CbusDoc::InitializeSearchContent()
{
...
void CbusDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
