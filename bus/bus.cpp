...
// bus.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CbusApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CbusApp::OnAppAbout)
...
CbusApp::CbusApp() noexcept
{
	...
	SetAppID(_T("bus.AppID.NoVersion"));
